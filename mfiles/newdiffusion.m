...
% where
%   T     = approximate solution at tfions, resp.
...
%      if count == 0
%         dt0 = 0.25 * min(dx,dy)^2 / maxD % print the value to see wether the code is unstable (running forever)
%      end
